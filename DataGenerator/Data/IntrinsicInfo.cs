    ...
    public static class IntrinsicInfo
    {
        ...
        public static (string, IntrinsicData) GetIntrinsicData(int ii)
        {
            ...
            else if (ii == 64)
            {
                ...
                ability.AfterBeingHits.Add(0, new AddContextStateEvent(new TaintedDrain(2), true));
                ability.OnRefresh.Add(0, new MiscEvent(new DrainDamageState(2)));
            }
            else if (ii == 65)
            {
            ...
            else if (ii == 270)
            {
                ...
                ability.AfterBeingHits.Add(0, new OnMoveUseEvent(new HitCounterEvent((Alignment.Friend | Alignment.Foe), false, false, true, 100, new ElementNeededEvent("fire", new StatusStackBattleEvent("mod_attack", true, true, false, false, 1, new StringKey("MSG_JUSTIFIED"))))));
            }
            else if (ii == 271)
            {
