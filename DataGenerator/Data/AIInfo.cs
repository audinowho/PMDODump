...
namespace DataGenerator.Data
{
    public static class AIInfo
    {
        public static void AddAIData()
        {
            ...
            tactic.ID = Text.Sanitize(tactic.Name.DefaultText).ToLower();
            iq = AIFlags.ItemGrabber | AIFlags.ItemMaster | AIFlags.KnowsMatchups | AIFlags.TeamPartner | AIFlags.PlayerSense;
            tactic.Plans.Add(new PreparePlan(iq | AIFlags.TrapAvoider, 0, 0, 0, AIPlan.AttackChoice.SmartAttack));
            tactic.Plans.Add(new WaitPlan(iq | AIFlags.TrapAvoider));
            Tactics.Add(tactic);
            ...
            tactic.Plans.Add(new PreBuffPlan(iq, 0, 0, 0, "last_used_move_slot"));
            tactic.Plans.Add(new AttackFoesPlan(iq, 0, 0, 4, AIPlan.AttackChoice.SmartAttack, AIPlan.PositionChoice.Avoid));
            tactic.Plans.Add(new FollowLeaderPlan(iq | AIFlags.TrapAvoider));
            tactic.Plans.Add(new ExplorePlan(iq | AIFlags.TrapAvoider));
            tactic.Plans.Add(new WaitPlan(iq | AIFlags.TrapAvoider));
            Tactics.Add(tactic);
            ...
            tactic.ID = Text.Sanitize(tactic.Name.DefaultText).ToLower();
            iq = AIFlags.ItemGrabber | AIFlags.ItemMaster | AIFlags.KnowsMatchups | AIFlags.AttackToEscape | AIFlags.WontDisturb | AIFlags.TeamPartner;
            tactic.Plans.Add(new AttackFoesPlan(iq | AIFlags.TrapAvoider, 0, 0, 4, AIPlan.AttackChoice.SmartAttack, AIPlan.PositionChoice.Avoid));
            tactic.Plans.Add(new FollowLeaderPlan(iq | AIFlags.TrapAvoider));
            tactic.Plans.Add(new ExplorePlan(iq | AIFlags.TrapAvoider));
            tactic.Plans.Add(new WaitPlan(iq | AIFlags.TrapAvoider));
            Tactics.Add(tactic);
            ...
            tactic.Plans.Add(new PreBuffPlan(iq | AIFlags.TrapAvoider, 0, 0, 0, "last_used_move_slot"));
            tactic.Plans.Add(new AttackFoesPlan(iq | AIFlags.TrapAvoider, 0, 0, 4, AIPlan.AttackChoice.RandomAttack, AIPlan.PositionChoice.Close));
            tactic.Plans.Add(new AvoidAlliesPlan(iq | AIFlags.TrapAvoider));//if cornered, don't do anything
            tactic.Plans.Add(new ExplorePlan(iq | AIFlags.TrapAvoider));
            tactic.Plans.Add(new WaitPlan(iq | AIFlags.TrapAvoider));
            Tactics.Add(tactic);
            ...
            tactic.Plans.Add(new AttackFoesPlan(iq | AIFlags.TrapAvoider, 0, 0, 4, AIPlan.AttackChoice.RandomAttack, AIPlan.PositionChoice.Avoid));
            tactic.Plans.Add(new AvoidAlliesPlan(iq | AIFlags.TrapAvoider));//if cornered, don't do anything
            tactic.Plans.Add(new ExplorePlan(iq | AIFlags.TrapAvoider));
            tactic.Plans.Add(new WaitPlan(iq | AIFlags.TrapAvoider));
            Tactics.Add(tactic);
