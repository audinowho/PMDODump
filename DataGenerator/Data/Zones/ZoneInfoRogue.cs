    ...
    public partial class ZoneInfo
    {
        ...
        static void FillGuildmaster(ZoneData zone)
        {
...

            {
                ...
                monsterChanceZoneStep.ItemThemes.Add(new ItemThemeMultiple(new ItemThemeDirect(new RandRange(1, 4), garnishList), new ItemThemeNone(50, new RandRange(2, 4))), new IntRange(0, max_floors), 20);//no theme
                ...
                monsterChanceZoneStep.ItemThemes.Add(new ItemThemeMultiple(new ItemThemeDirect(new RandRange(1, 4), garnishList), new ItemStateType(new FlagType(typeof(EvoState)), true, true, new RandRange(2, 4))), new IntRange(0, 10), 40);//evo items
                monsterChanceZoneStep.ItemThemes.Add(new ItemThemeMultiple(new ItemThemeDirect(new RandRange(1, 4), garnishList), new ItemStateType(new FlagType(typeof(EvoState)), true, true, new RandRange(2, 4))), new IntRange(10, 20), 20);//evo items
                for (int ii = 0; ii < dexMap.Length; ii++)
                    monsterChanceZoneStep.Mobs.Add(GetHouseMob(dexMap[ii], "wander_smart"), new IntRange(0, max_floors), 10);//all monsters in the game
                monsterChanceZoneStep.MobThemes.Add(new MobThemeNone(50, new RandRange(7, 13)), new IntRange(19, max_floors), 10);
                ...
                monsterChanceZoneStep.MobThemes.Add(new MobThemeTypingSeeded(EvoFlag.FinalEvo | EvoFlag.NoEvo | EvoFlag.MidEvo, new RandRange(7, 13)), new IntRange(20, max_floors), 10);
                floorSegment.ZoneSteps.Add(monsterChanceZoneStep);
            }

            {
                //monster halls
                SpreadHouseZoneStep monsterChanceZoneStep = new SpreadHouseZoneStep(PR_HOUSES, new SpreadPlanChance(10, new IntRange(15, max_floors)));
                ...
                PopulateHallItems(monsterChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.MainPath, max_floors);
...

            {
                ...
                foreach (string tm_id in IterateDistroTMs(TMDistroClass.Natural))
                    chestChanceZoneStep.Items.Add(new MapItem(tm_id), new IntRange(0, max_floors), 2);//TMs

                PopulateChestItems(chestChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.MainPath, false, max_floors);
...

            {
                ...
                PopulateChestItems(chestChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.MainPath, true, max_floors);
...

            {
                ...
                PopulateBossItems(bossChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.MainPath, max_floors);
        ...
        static void FillSecretGarden(ZoneData zone)
        {
            ...
            {
                TeamMemberSpawn mob = GetTeamMob("farfetchd", "defiant", "aerial_ace", "knock_off", "", "", new RandRange(21), TeamMemberSpawn.MemberRole.Loner, "wander_normal", true);
                MobSpawnItem itemSpawn = new MobSpawnItem(true);
                foreach (string item_name in IteratePinchBerries())
                    itemSpawn.Items.Add(new InvItem(item_name), 100);
                mob.Spawn.SpawnFeatures.Add(itemSpawn);
            ...
            {
                TeamMemberSpawn mob = GetTeamMob("comfey", "", "natural_gift", "flower_shield", "", "", new RandRange(22), TeamMemberSpawn.MemberRole.Leader);
            ...
            poolSpawn.Spawns.Add(GetTeamMob("machamp", "no_guard", "dynamic_punch", "", "", "", new RandRange(43)), new IntRange(25, 28), 10);
            ...
            //spawn with berry
            {
                TeamMemberSpawn mob = GetTeamMob("altaria", "", "dragon_breath", "safeguard", "natural_gift", "", new RandRange(45), TeamMemberSpawn.MemberRole.Leader);
            ...
            //spawn with berry
            {
                TeamMemberSpawn mob = GetTeamMob("tropius", "harvest", "sweet_scent", "leaf_storm", "", "", new RandRange(45), TeamMemberSpawn.MemberRole.Support, "item_finder");
            ...
            poolSpawn.Spawns.Add(GetTeamMob("alakazam", "", "psychic", "telekinesis", "", "", new RandRange(54), TeamMemberSpawn.MemberRole.Leader), new IntRange(37, 40), 10);
            poolSpawn.Spawns.Add(GetTeamMob("manectric", "", "electric_terrain", "discharge", "fire_fang", "", new RandRange(54)), new IntRange(37, 40), 10);
            ...
            {
                //monster houses
                SpreadHouseZoneStep monsterChanceZoneStep = new SpreadHouseZoneStep(PR_HOUSES, new SpreadPlanChance(10, new IntRange(3, max_floors)));
                monsterChanceZoneStep.HouseStepSpawns.Add(new MonsterHouseStep<ListMapGenContext>(GetAntiFilterList(new ImmutableRoom(), new NoEventRoom())), 10);
                ...
                PopulateHouseItems(monsterChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.Unlockable, max_floors);

                SpawnList<MapItem> garnishList = new SpawnList<MapItem>();
                garnishList.Add(new MapItem("loot_pearl", 2), 10);
                monsterChanceZoneStep.ItemThemes.Add(new ItemThemeMultiple(new ItemThemeDirect(new RandRange(1, 4), garnishList), new ItemThemeNone(80, new RandRange(2, 4))), new IntRange(0, max_floors), 30);//no theme
                ...
                monsterChanceZoneStep.ItemThemes.Add(new ItemStateType(new FlagType(typeof(GummiState)), true, true, new RandRange(3, 7)), new IntRange(0, max_floors), 30);//gummis
                monsterChanceZoneStep.ItemThemes.Add(new ItemThemeMultiple(new ItemThemeDirect(new RandRange(1, 4), garnishList), new ItemStateType(new FlagType(typeof(EvoState)), true, true, new RandRange(2, 4))), new IntRange(0, 10), 20);//evo items
                monsterChanceZoneStep.ItemThemes.Add(new ItemThemeMultiple(new ItemThemeDirect(new RandRange(1, 4), garnishList), new ItemStateType(new FlagType(typeof(EvoState)), true, true, new RandRange(2, 4))), new IntRange(10, 20), 10);//evo items
...

            {
                ...
                SpawnList<MapItem> garnishList = new SpawnList<MapItem>();
                garnishList.Add(new MapItem("loot_pearl", 2), 10);
                monsterChanceZoneStep.ItemThemes.Add(new ItemThemeMultiple(new ItemThemeDirect(new RandRange(1, 4), garnishList), new ItemThemeNone(80, new RandRange(2, 4))), new IntRange(0, 30), 30);//no theme
...

            {
                ...
                PopulateChestItems(chestChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.Unlockable, false, max_floors);
            ...
            //switch vaults
            {
                ...
                PopulateFOEItems(vaultChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.Unlockable, 30);
...

            {
                ...
                PopulateBossItems(bossChanceZoneStep, DungeonStage.Rogue, DungeonAccessibility.Unlockable, max_floors);
            ...
            for (int ii = 0; ii < max_floors; ii++)
            {
                ...
                Dictionary<ItemFake, MobSpawn> spawnTable = new Dictionary<ItemFake, MobSpawn>();
                if (ii < 10)
                    spawnTable.Add(new ItemFake("food_apple", "applin"), GetGenericMob("applin", "ripen", "astonish", "", "", "", new RandRange(12)));
                else if (ii < 14)
                    spawnTable.Add(new ItemFake("food_apple", "applin"), GetGenericMob("applin", "ripen", "astonish", "", "", "", new RandRange(20)));
                else if (ii < 18)
                    spawnTable.Add(new ItemFake("food_apple", "applin"), GetGenericMob("applin", "gluttony", "astonish", "withdraw", "", "", new RandRange(24)));
                else if (ii < 20)
                    spawnTable.Add(new ItemFake("food_apple", "applin"), GetGenericMob("applin", "gluttony", "astonish", "withdraw", "", "", new RandRange(30)));
                else if (ii < 28)
                    spawnTable.Add(new ItemFake("food_apple_big", "flapple"), GetGenericMob("flapple", "gluttony", "grav_apple", "dragon_dance", "", "", new RandRange(36)));
                else
                    spawnTable.Add(new ItemFake("food_apple_big", "flapple"), GetGenericMob("flapple", "gluttony", "grav_apple", "dragon_dance", "acrobatics", "", new RandRange(45)));
                AddFloorFakeItems(layout, spawnTable);
                ...
                if (ii <= 4)
                    ...
                    AddTextureData(layout, "western_cave_2_wall", "western_cave_2_floor", "western_cave_2_secondary", "dragon");
                else if (ii <= 34)
                ...
                if (ii >= 3 && ii < 7)
                {
                    ...
                    LoopedTeamSpawner<MapGenContext> spawner = new LoopedTeamSpawner<MapGenContext>(specificTeam);
                    {
                        spawner.AmountSpawner = new RandBinomial(2, 50);
                    }
                    PlaceRandomMobsStep<MapGenContext> secretMobPlacement = new PlaceRandomMobsStep<MapGenContext>(spawner);
                    layout.GenSteps.Add(PR_SPAWN_MOBS, secretMobPlacement);
                }
                ...
                if (ii <= 8)
                    ...
                    AddRespawnData(layout, 14, 95);
                else if (ii <= 20)
                    AddRespawnData(layout, 16, 100);
                else if (ii <= 27)
                    AddRespawnData(layout, 24, 110);
                else
                ...
                if (ii <= 8)
                    ...
                    AddEnemySpawnData(layout, 20, new RandRange(15, 19));
                else
                ...
                SpawnList<MapItem> wallSpawns = new SpawnList<MapItem>();
                PopulateWallItems(wallSpawns, DungeonStage.Rogue, DungeonEnvironment.Forest);
        ...
        static void FillPrismIsles(ZoneData zone)
        {
            #region PRISM ISLES
            {
        ...
        static void FillLabyrinthOfTheLost(ZoneData zone)
        {
