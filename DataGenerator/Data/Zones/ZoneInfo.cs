    ...
    public partial class ZoneInfo
    {
        ...
        public static void AddZoneData(params int[] zonesToAdd)
        {
            ...
            if (zonesToAdd.Length > 0)
            {
                ...
                {
                    ZoneData zone = GetZoneData(zonesToAdd[ii]);
        ...
        public static ZoneData GetZoneData(int index)
        {
                ...
                #region MOONLIT COURTYARD
                {
...

                    {
                        ...
                        for (int ii = 0; ii < max_floors; ii++)
                        {
                            ...
                            AddGrassSteps(layout, new RandRange(1, 6), new IntRange(2, 7), new RandRange(0));
...

                    {
                        ...
                        for (int ii = 0; ii < max_floors; ii++)
                        {
                            ...
                            RoomTerrainStep<MapGenContext> trapStep = new RoomTerrainStep<MapGenContext>(new Tile("water"), new RandRange(5, 8), true);
                            ...
                            //construct paths
                            {
                                ...
                                SpawnList<RoomGen<MapGenContext>> genericRooms = new SpawnList<RoomGen<MapGenContext>>();
                                //cross
                                genericRooms.Add(new RoomGenCross<MapGenContext>(new RandRange(4, 9), new RandRange(4, 9), new RandRange(2, 6), new RandRange(2, 6)), 10);
                                //round
                                genericRooms.Add(new RoomGenRound<MapGenContext>(new RandRange(4, 8), new RandRange(4, 8)), 10);
                                path.GenericRooms = genericRooms;
            ...
            else if (index == 16)
            {
                #region FORSAKEN DESERT
                {
                    ...
                    //money
                    MoneySpawnZoneStep moneySpawnZoneStep = GetMoneySpawn(zone.Level * 10, 10);
                    moneySpawnZoneStep.ModStates.Add(new FlagType(typeof(CoinModGenState)));
                    floorSegment.ZoneSteps.Add(moneySpawnZoneStep);
                ...
                #region SNOWBOUND PATH
                {
...

                    {
                        ...
                        for (int ii = 0; ii < max_floors; ii++)
                        {
                            ...
                            {
                                if (ii < 14)
                                    AddInitGridStep(layout, 6, 4, 8, 8);
                                else
            ...
            else if (index == 24)
            {
                #region COPPER QUARRY
                {
...

                    {
                        ...
                        floorSegment.IsRelevant = true;
                        floorSegment.ZoneSteps.Add(new SaveVarsZoneStep(PR_EXITS_RESCUE));
                        floorSegment.ZoneSteps.Add(new FloorNameIDZoneStep(PR_FLOOR_DATA, new LocalText("Copper Quarry\n{0}F")));
