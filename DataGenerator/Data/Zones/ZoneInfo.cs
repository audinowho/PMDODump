        ...
        public static ZoneData GetZoneData(int index, bool translate)
        {
            ...
            else if (index == 2)
            {
...

                {
                    ...
                    string unown = "play";
                    multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Beginner, "small_square", -2, false, false), 10);
                    multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Beginner, "tall_hall", -2, false, false), 10);
                    multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Beginner, "wide_hall", -2, false, false), 10);
            ...
            else if (index == 4)
            {
                #region FLYAWAY CLIFFS
                {
                    ...
                    //switch vaults
                    {
                        ...
                        PopulateVaultItems(vaultChanceZoneStep, DungeonStage.Beginner, DungeonAccessibility.MainPath, max_floors, false);
                ...
                #region THUNDERSTRUCK PASS
                {
...

                    {
...

                        {
                            ...
                            PopulateHouseItems(monsterChanceZoneStep, DungeonStage.Beginner, DungeonAccessibility.MainPath, max_floors);
                        ...
                        //switch vaults
                        {
                            ...
                            //items for the vault
                            PopulateFOEItems(vaultChanceZoneStep, DungeonStage.Intermediate, DungeonAccessibility.MainPath, max_floors);
            ...
            else if (index == 7)
            {
                ...
                zone.Rogue = RogueStatus.NoTransfer;
                {
...

                    {
                        ...
                        monsterChanceZoneStep.Items.Add(new MapItem("food_apple_perfect"), new IntRange(0, max_floors), 20);//perfect apple
                        monsterChanceZoneStep.Items.Add(new MapItem("food_banana_big"), new IntRange(0, max_floors), 10);//big banana

                        PopulateHouseItems(monsterChanceZoneStep, DungeonStage.Advanced, DungeonAccessibility.MainPath, max_floors);
...

                    {
                        ...
                        PopulateChestItems(chestChanceZoneStep, DungeonStage.Advanced, DungeonAccessibility.MainPath, false, max_floors);
...

                {
                    ...
                    ChanceFloorGen multiGen = new ChanceFloorGen();
                    string unown = "final";
                    multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Advanced, "small_square", -2, true, true), 10);
                    structure.BaseFloor = multiGen;
            ...
            else if (index == 17)
            {
...

                {
...

                    {
                        ...
                        PopulateHouseItems(monsterChanceZoneStep, DungeonStage.Intermediate, DungeonAccessibility.MainPath, max_floors);
                ...
                string unown = "patience";
                {
                    SingularSegment structure = new SingularSegment(-1);

                    ChanceFloorGen multiGen = new ChanceFloorGen();
                    multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Intermediate, "small_square", -3, false, true), 10);
                    multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Intermediate, "tall_hall", -3, false, true), 10);
                    multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Intermediate, "wide_hall", -3, false, true), 10);
                    structure.BaseFloor = multiGen;
                ...
                #region COPPER QUARRY
                {
...

                    {
...

                        {
...

                            {
                                ...
                                PopulateVaultItems(detourChanceZoneStep, DungeonStage.Beginner, DungeonAccessibility.MainPath, max_floors, true, true);
...

                            {
                                ...
                                PopulateVaultItems(vaultChanceZoneStep, DungeonStage.Beginner, DungeonAccessibility.MainPath, max_floors, true);
...

                    {
                        ...
                        for (int ii = 0; ii < max_floors; ii++)
                        {
                            ...
                            //Floor settings
                            AddFloorData(layout, "Lodestone Quarry.ogg", 1500, Map.SightRange.Clear, Map.SightRange.Dark);
                    ...
                    string unown = "value";
                    {
                        ...
                        ChanceFloorGen multiGen = new ChanceFloorGen();
                        multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Intermediate, "small_square", -3, false, false), 10);
                        multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Intermediate, "tall_hall", -3, false, false), 10);
                        multiGen.Spawns.Add(getMysteryRoom(translate, zone.Level, unown, DungeonStage.Intermediate, "wide_hall", -3, false, false), 10);
                        structure.BaseFloor = multiGen;
