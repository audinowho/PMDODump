...
namespace DataGenerator.Data
{
    public class MapInfo
    {
        ...
        public static Map GetMapData(string name)
        {
            ...
            if (name == MapNames[3])
            {
                ...
                team.SetRank("normal");
                {
                    ...
                    mobData.Level = 20;
                    mobData.BaseSkills[0] = new SlotSkill(33);
            ...
            else if (name == MapNames[8])
            {
                ...
                //Summit
                {
                    ...
                    mobData.Level = 60;
                    mobData.BaseSkills[0] = new SlotSkill(248);
                ...
                }
                {
                    ...
                    mobData.Level = 60;
                    mobData.BaseSkills[0] = new SlotSkill(396);
                ...
                }
                {
                    ...
                    mobData.Level = 60;
                    mobData.BaseSkills[0] = new SlotSkill(47);
        ...
        public static void AddGroundData(string name)
        {
            ...
            if (data != null)
                DataManager.SaveData(PathMod.ModPath(DataManager.GROUND_PATH + name + DataManager.GROUND_EXT), data);
        }
